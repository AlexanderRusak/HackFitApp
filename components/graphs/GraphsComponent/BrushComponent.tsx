...
import { VictoryArea, VictoryAxis, VictoryBar, VictoryBrushContainer, VictoryChart, VictoryLine, VictoryTheme } from "victory-native"
...
export const BrushComponent = ({ color, rangeX, rangeY, data, brushDomain, onBrushDomainChange, interpolationType }: BrushComponentProps) => {
